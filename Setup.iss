...
AppVerName="ШТРИХ-М: Принтер чеков 1.38"
...
AppCopyright="Copyright © 2025 ШТРИХ-М  ©®™"
;Версия
VersionInfoCompany="ШТРИХ-М"
VersionInfoDescription="Принтер чеков"
VersionInfoTextVersion="1.38.0.0"
...
; Основные
Name: "{group}\Принтер чеков 1.38"; Filename: "{app}\RcptPrn.exe"; WorkingDir: "{app}";
...
Name: "{userdesktop}\Принтер чеков 1.38"; Filename: "{app}\RcptPrn.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Принтер чеков 1.38"; Filename: "{app}\RcptPrn.exe"; Tasks: quicklaunchicon
[Run]
