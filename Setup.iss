...
AppVerName="ШТРИХ-М: Принтер чеков 1.39"
...
VersionInfoTextVersion="1.39.0.0"
...
; Основные
Name: "{group}\Принтер чеков 1.39"; Filename: "{app}\RcptPrn.exe"; WorkingDir: "{app}";
...
Name: "{userdesktop}\Принтер чеков 1.39"; Filename: "{app}\RcptPrn.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Принтер чеков 1.39"; Filename: "{app}\RcptPrn.exe"; Tasks: quicklaunchicon
[Run]
