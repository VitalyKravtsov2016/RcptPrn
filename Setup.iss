...
AppVerName="ШТРИХ-М: Принтер чеков 1.35"
...
AppCopyright="Copyright © 2023 ШТРИХ-М  ©®™"
;Версия
VersionInfoCompany="ШТРИХ-М"
VersionInfoDescription="Принтер чеков"
VersionInfoTextVersion="1.35.0.0"
...
; Основные
Name: "{group}\Принтер чеков 1.35"; Filename: "{app}\RcptPrn.exe"; WorkingDir: "{app}";
...
Name: "{userdesktop}\Принтер чеков 1.35"; Filename: "{app}\RcptPrn.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Принтер чеков 1.35"; Filename: "{app}\RcptPrn.exe"; Tasks: quicklaunchicon
[Run]
